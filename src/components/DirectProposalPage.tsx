...
export function DirectProposalPage({ onSelectView }: DirectProposalPageProps) {
  ...
  const handleAutoFill = () => {
    setTitle('buy r4to');
    setDescription(`SUMMARY Purchase 0.0001 ETH worth of r4to creator coin via Zora marketplace. COIN DETAILS Address: 0xeb77e5b060372a8a6e64ceb47e5b4c1bb650d3c8 Symbol: r4to Name: r4to TRADE PARAMETERS ETH Amount: 0.01 ETH Max Slippage: 5% Sender: DAO Treasury (0x3ed26c1d23Fd4Ea3B5e2077B60B4F1EC80Aba94f) Recipient: DAO Treasury (coins return to DAO) RATIONALE The 'latenightonbase' creator coin shows potential for long-term value creation, given its current price and decent trading volume of approximately $24,120.94 over the last 24 hours. However, it is essential to consider diversification, as this coin is a new exposure for the DAO, which allows for a balanced investment strategy without over-concentration in a single asset. SOURCE This proposal was generated by: manual TRANSACTION DETAILS This proposal will execute a swap through the Uniswap v4 router with Zora creator coin hooks. The transaction is generated using the Zora Coins SDK's createTradeCall() function. Generated by AI Treasurer Agent --- Coin Purchase Details: - Coin: r4to - ETH Amount: 0.0001 ETH - Slippage Tolerance: 15% --- Coin Purchase Details: - Coin: r4to - ETH Amount: 0.0001 ETH - Slippage Tolerance: 14.6%`);
    setCoinAddress('0xeb77e5b060372a8a6e64ceb47e5b4c1bb650d3c8');
    setCoinName('r4to');
    setEthAmount('0.0001');
    setSlippage('5');
    setValidationErrors({});
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-4 py-2 text-sm bg-accent hover:bg-accent/80 border border-border rounded-lg transition-colors"
                disabled={status === 'generating' || status === 'submitting'}
              >
                Auto-fill Example (r4to)
              </button>
            </div>
